...
$Insertarnc = "INSERT into felectronicaServiciosAnulados(inm_id,autorizacion,estado) VALUES('".$IDReceptor_."','".$NoDocto_."','A') ";
$buscar2   = sqlsrv_query($con, $Insertarnc);

$deletetarnc = "DELETE from ecuenta where inm_id='$IDReceptor_' and cae='$cae_' and autorizacion='$NoDocto_' ";
$buscar   = sqlsrv_query($con, $deletetarnc);
