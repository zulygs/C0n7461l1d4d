...
if (empty($_SESSION['idUser'])) {
    ...
    if (isset($_POST['insertaa'])) {
        $usu_  = $_POST['Fecha'];
        $usu1_ = $_POST['Fecha1'];
        header("Location: ReporteContaPDF3.php?Fecha_=$usu_&%20Fecha1_=" . urlencode($usu1_));
    }}
...
?>
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-lg1" id="lateral">
         <form  method="POST" action="SerieSC.php" >
         <center>
      ...
      <input type="date" class="form-control" name="Fecha1" style="width: 200px" value="<?php echo $fcha1; ?>" required>
        ...
        <div class="form-group margen">
          ...
          <input type="submit" id="click" name="insertaa" class="btn btn-primary btn-lg" style="background-color: green;" value="Excel" >
