...
if (empty($_SESSION['idUser'])) {
    ...
    if (isset($_POST['inserta'])) {
        $usu_  = $_POST['Fecha'];
        $usu1_ = $_POST['Fecha1'];
        header("Location: ReporteContaPDF11.php?Fecha_=$usu_&%20Fecha1_=" . urlencode($usu1_));
    }
}
...
?>
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-lg1" id="lateral">
         <form  method="POST" action="AnulacionesReporte.php" >
         <center>
...
<button type="submit" id="click" name="inserta" class="btn btn-primary" style="background-color: white;width: 150px" value="Excel" ><img src="assets/img/pdf.ico" alt="SomeAlternateText"></button>
