...
header('Content-Disposition: attachment; filename=IVA/'.$Fecha.' al '.$Fechaa.'.xls');
...
from ecuenta where cast(dia_Fecha as date) between '$Fecha' and '$Fechaa' and tra_Codigo='EI'
order by dia_Fecha";


      $R=sqlsrv_query($con,$Consulta);
      echo "<table border='1' cellpadding='2' cellspacing='0' width='100%'>
   <caption><font color='red' size='10'>Extensiones De IVA</font></caption>
    <tr>
        <td>Fecha</td>
        <td>Lote</td>
        <td>Nombre</td>
